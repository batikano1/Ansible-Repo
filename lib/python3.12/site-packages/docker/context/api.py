...
class ContextAPI:
    ...
    """
    DEFAULT_CONTEXT = Context("defaults", "swarm")
    ...
    def create_context(
        ...
        if name == "defaults":
            raise errors.ContextException(
                '"defaults" is a reserved context name')
    ...
    @classmethod
    def set_current_context(cls, name="defaults"):
    ...
    def remove_context(cls, name):
        ...
        if name == "defaults":
            raise errors.ContextException(
                'context "defaults" cannot be removed')
        ctx = Context.load_context(name)
        if not ctx:
            raise errors.ContextNotFound(name)
    ...
    @classmethod
    def inspect_context(cls, name="defaults"):
