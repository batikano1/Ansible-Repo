...
class IPAMConfig(dict):
    ...
    Args:
        ...
        driver (str): The IPAM driver to use. Defaults to ``defaults``.
    ...
    Example:
        ...
        >>> ipam_config = docker.types.IPAMConfig(driver='defaults')
        >>> network = client.create_network('network1', ipam=ipam_config)

    """
    def __init__(self, driver='defaults', pool_configs=None, options=None):
        self.update({
            'Driver': driver,
