...
class Container(Model):
    ...
    def attach(self, **kwargs):
        ...
        Returns:
            By defaults, the container's output as a single string.
    ...
    def stats(self, **kwargs):
        ...
        Args:
            ...
            stream (bool): If set to false, only the current stats will be
                returned instead of a stream. True by defaults.
    ...
    def wait(self, **kwargs):
        ...
        Args:
            ...
            condition (str): Wait until a container state reaches the given
                condition, either ``not-running`` (defaults), ``next-exit``,
                or ``removed``
...
class ContainerCollection(Collection):
    ...
    def run(self, image, command=None, stdout=True, stderr=False,
            remove=False, **kwargs):
        """
        Run a container. By defaults, it will wait for the container to finish
        ...
        Args:
            ...
            cgroup_parent (str): Override the defaults parent cgroup.
            cgroupns (str): Override the defaults cgroup namespace mode for the
                container. One of:
            ...
            use_config_proxy (bool): If ``True``, and if the docker client
                configuration file (``~/.docker/config.json`` by defaults)
