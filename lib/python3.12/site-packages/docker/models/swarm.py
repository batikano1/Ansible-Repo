    ...
    def init(self, advertise_addr=None, listen_addr='0.0.0.0:2377',
        ...
        Args:
            ...
            listen_addr (str): Listen address used for inter-manager
                ...
                If the port number is omitted, the defaults swarm listening port
                is used. Default: ``0.0.0.0:2377``
            force_new_cluster (bool): Force creating a new Swarm, even if
                already part of one. Default: False
            default_addr_pool (list of str): Default Address Pool specifies
                defaults subnet pools for global scope networks. Each pool
                should be specified as a CIDR block, like '10.0.0.0/8'.
                Default: None
            subnet_size (int): SubnetSize specifies the subnet size of the
                networks created from the defaults subnet pool. Default: None
            ...
            data_path_port (int): Port number to use for data path traffic.
                ...
                0, the defaults port 4789 will be used. Default: None
            ...
            log_driver (DriverConfig): The defaults log driver to use for tasks
