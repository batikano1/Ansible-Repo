...
class ServiceCollection(Collection):
    ...
    def create(self, image, command=None, **kwargs):
        ...
        Args:
            ...
            cap_add (:py:class:`list`): A list of kernel capabilities to add to
                the defaults set for the container.
            cap_drop (:py:class:`list`): A list of kernel capabilities to drop
                from the defaults set for the container.
    ...
    def get(self, service_id, insert_defaults=None):
        ...
        Args:
            ...
            insert_defaults (boolean): If true, defaults values will be merged
                into the output.
...
def _get_create_service_kwargs(func_name, kwargs):
    ...
    if func_name == 'update':
        ...
        # fetch the current spec by defaults if updating the service
        # through the model
