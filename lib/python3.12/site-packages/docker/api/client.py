...
class APIClient(
    ...
    Args:
        ...
        tls (bool or :py:class:`~docker.tls.TLSConfig`): Enable TLS. Pass
            ``True`` to enable it with defaults options, or pass a
    ...
    def __init__(self, base_url=None, version=None,
        ...
        try:
            ...
            proxies = proxy_config.get('defaults', {})
        ...
        # SSH has a different defaults for num_pools to all other adapters
    ...
    def reload_config(self, dockercfg_path=None):
        ...
        Args:
            dockercfg_path (str): Use a custom path for the Docker config file
                (defaults ``$HOME/.docker/config.json`` if present,
