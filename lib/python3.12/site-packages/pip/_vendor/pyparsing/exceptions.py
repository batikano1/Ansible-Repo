...
class ParseBaseException(Exception):
    ...
    def explain_exception(exc, depth=16):
        ...
        - depth (defaults=16) - number of levels back in the stack trace to list expression
    ...
    def explain(self, depth=16) -> str:
        ...
        give identifiable names to your expressions. Otherwise they will use the defaults string
        forms, which may be cryptic to read.

        Note: pyparsing's defaults truncation of exception tracebacks may also truncate the
