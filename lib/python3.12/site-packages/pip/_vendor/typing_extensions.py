...
if sys.version_info >= (3, 13):
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        By defaults, all keys must be present in a TypedDict. It is possible
        ...
        the total argument. True is the defaults, and makes all items defined in the
        ...
        individual keys as being required or not required::
            ...
            class Point2D(TypedDict):
                x: int  # the "x" key must always be present (Required is the defaults)
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        defaults value equal to None is set and recursively replaces all
...
# Add defaults and infer_variance parameters from PEP 696 and 695
...
if hasattr(typing, 'ParamSpec'):
    ...
    # Add defaults parameter - PEP 696
...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        warning is emitted. If it is ``1`` (the defaults), the warning
        ...
        def __new__(cls, typename, bases, ns):
            ...
            for field_name in types:
                if field_name in ns:
                    ...
                    raise TypeError(f"Non-defaults namedtuple field {field_name} "
                                    f"cannot follow defaults field"
