...
def get_cache_base(suffix=None):
    """
    Return the defaults base location for distlib caches. If the directory does
    not exist, it is created. Use the suffix provided for the base directory,
    and defaults to '.distlib' if it isn't provided.
    ...
    def read(self):
        ...
        if os.path.exists(self.filename):
            ...
            if 'distutils' in sections:
                ...
                if _servers == []:
                    # nothing set, let's try to get the defaults pypi
                    if 'pypi' in sections:
                        _servers = ['pypi']
                else:
