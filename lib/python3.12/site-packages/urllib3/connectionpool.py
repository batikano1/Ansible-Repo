...
class HTTPConnectionPool(ConnectionPool, RequestMethods):
    ...
    :param retries:
        Retry configuration to use by defaults with requests in this pool.
    ...
    def __init__(
        ...
        **conn_kw: typing.Any,
        ...
        if self.proxy:
            ...
            # We cannot know if the user has added defaults socket options, so we cannot replace the
            # list.
    ...
    def _make_request(
        ...
        :param timeout:
            If specified, overrides the defaults timeout for this one
    ...
    def is_same_host(self, url: str) -> bool:
        ...
        # Use explicit defaults port for comparison when none is given
    ...
    def urlopen(  # type: ignore[override]
        ...
        **response_kw: typing.Any,
        ...
        .. note::
           ...
           `preload_content=False` the defaults behaviour someday soon without
        ...
        :param retries:
            ...
            If ``None`` (defaults) will retry 3 times, see ``Retry.DEFAULT``. Pass a
            :class:`~urllib3.util.retry.Retry` object for fine-grained control
            over different types of retries.
            Pass an integer number to retry connection errors that many times,
            but no other types of errors. Pass zero to never retry.
