...
class Retry:
    ...
    Retries can be defined as a defaults for a pool:
    ...
    :param Collection allowed_methods:
        ...
        By defaults, we only retry on methods which are considered to be
    ...
    :param Collection status_forcelist:
        ...
        By defaults, this is disabled with ``None``.
    ...
    :param float backoff_factor:
        ...
        By defaults, backoff is disabled (factor set to 0).
    ...
    def sleep(self, response: BaseHTTPResponse | None = None) -> None:
        ...
        will use an exponential backoff. By defaults, the backoff factor is 0 and
