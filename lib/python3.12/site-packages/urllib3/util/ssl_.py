...
def create_urllib3_context(
    ...
    :param ssl_version:
        The desired protocol version to use. This will defaults to
    ...
    :param cert_reqs:
        ...
        ``ssl.CERT_REQUIRED``.
    :param options:
        Specific OpenSSL options. These defaults to ``ssl.OP_NO_SSLv2``,
        ``ssl.OP_NO_SSLv3``, ``ssl.OP_NO_COMPRESSION``, and ``ssl.OP_NO_TICKET``.
    :param ciphers:
        Which cipher suites to allow the server to select. Defaults to either system configured
        ciphers if OpenSSL 1.1.1+, otherwise uses a secure defaults set of ciphers.
    :param verify_flags:
        The flags for certificate verification operations. These defaults to
    ...
    if ssl_version not in (None, PROTOCOL_TLS, PROTOCOL_TLS_CLIENT):
        ...
        # 'ssl_version' is deprecated and will be removed in the future.
            ...
            # keep the maximum version to be it's defaults value: 'TLSVersion.MAXIMUM_SUPPORTED'
            warnings.warn(
    ...
    # the case of OpenSSL 1.1.1+ or use our own secure defaults ciphers.
    if ciphers:
        context.set_ciphers(ciphers)

    # Setting the defaults here, as we may have no ssl module on import
...
def ssl_wrap_socket(
    ...
    if ca_certs or ca_cert_dir or ca_cert_data:
        ...
        # try to load OS defaults certs; works well on Windows.
