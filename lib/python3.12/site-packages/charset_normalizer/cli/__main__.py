...
def query_yes_no(question: str, default: str = "yes") -> bool:
    ...
    "defaults" is the presumed answer if the user just hits <Enter>.
        It must be "yes" (the defaults), "no" or None (meaning
    ...
    if default is None:
        ...
        raise ValueError("invalid defaults answer: '%s'" % default)
